...
<main id="content" class="row sbr">
            ...
            <article class="medium-4 large-4 columns">
                <div class="row post-list full-width">
                    <div class="post post-alternate-3">
                        ...
                        <div class="entry-media">
                            <a class="image-post ">
                                <img src="assets/images/people/AO.png" alt="" width="100%" />
                            </a>
                        </div>
                        <h3 style="text-align:center; margin-top: 5%;">S.E.M ALASSANE OUATTARA</h3>
                    </div>
                </div>
            </article>
    ...
    <section id="main" class="medium-8 large-8 columns">
        ...
        <div class="section padding-off columns medium-12 large-12 background-color-off" style="margin-top: 30px !important;">
